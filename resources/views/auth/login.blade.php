...
@section('title') Pabble: {{ __('lang.login') }} @endsection
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('login') }}">
                        ...
                        <div class="form-group{{ $errors->has('username') ? ' has-error' : '' }}">
                            <label for="email" class="col-md-4 control-label">{{ __('lang.username').' '.__('lang.or').' '.__('lang.email') }}</label>
                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-md-offset-4">
                                <div class="checkbox">
                                    <label>
                                        <input checked type="checkbox" name="remember" {{ old('remember') ? 'checked' : '' }}> {{ __('lang.remember-me') }}
                                    </label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="col-md-8 col-md-offset-4">
                                ...
                                <a class="btn btn-link" href="{{ route('auth.activate.resend') }}">
                                    {{ __("lang.resend-activation-email") }}
                                </a>
                            </div>
                        </div>
                    </form>
