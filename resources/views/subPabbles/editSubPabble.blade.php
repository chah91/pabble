...
@section('title') Edit {{ $pabble->name }} @endsection
        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel">
                <div class="panel-heading">
                    <h2>Edit <a href="/p/{{$pabble->name}}">/p/{{$pabble->name}}</a></h2>
                </div>
                ...
                <div class="panel-body">
                    <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group{{ $errors->has('title') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-9">
                                <input placeholder="Title" id="title" type="text" class="form-control" name="title" value="@if (!empty(old('title'))) {{ old('title') }} @else{{$pabble->title}}@endif">
                        ...
                        <div class="form-group">
                            <div class="col-md-11">
                                <div class="col-md-2 col-md-offset-2 col-xs-2">
                                    <a href="/p/{{$pabble->name}}/edit/css">Edit css</a>
                                </div>
                                <div class="col-md-8 col-xs-10">
                                    <input type="submit" value="Update pabble" class="btn btn-primary pull-right">
                                </div>
                            </div>
                        </div>
